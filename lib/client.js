    ...
    function sameState(a, b) {
      var sameBalance = a.balance === null && b.balance === null
        ...
        : a.balance !== null && b.balance !== null
          ...
          : false;
      var sameModel = a.model === null && b.model === null
        ? true
    ...
    function apply(ctx) {
      ctx.slots.inject("conversation.input.dock", function () {
        return ctx.slots.register(
          ...
          { name: "conversation.input.dock", id: "balance-hud", order: 1, label: "Balance HUD" },
          react.memo(function BalanceDock(props) {
            var pressure = props.useProjection ? props.useProjection("contextPressure") : undefined;
            var statePair = react.useState({ balance: null, today: { tokens: 0, cost: 0 }, model: null });
            ...
            var showWalletSpend = !state.model || state.model.deepseek !== false;
